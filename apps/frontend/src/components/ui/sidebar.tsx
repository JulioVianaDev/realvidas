...
function SidebarTrigger({
    ...
    return (
        <Button
            ...
            size="icon"
            className={cn(
                `w-full ${!open ? "" : "justify-start pl-4"} hover:bg-sidebar-accent dark:hover:bg-sidebar-accent  dark:hover:text-black `,
                className,
            )}
            onClick={(event) => {
                onClick?.(event);
    ...
    return (
        <div
            ...
            className={cn(
                ...
                "scrollbar-thin scrollbar-track-transparent scrollbar-thumb-primary",
                className,
            )}
            {...props}
        />
