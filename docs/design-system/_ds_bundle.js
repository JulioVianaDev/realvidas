...
const __ds_ns = (window.RealVidasDesignSystem_066fed = window.RealVidasDesignSystem_066fed || {});
...
function Button({
  ...
  const inner = /*#__PURE__*/React.createElement(React.Fragment, null, loading && /*#__PURE__*/React.createElement(Spinner, null), !loading && leftIcon, children && /*#__PURE__*/React.createElement("span", null, children), !loading && rightIcon);
  if (href && !isDisabled) {
...
function PlanCard({
  ...
  }), "Plano ", t.label), featured && /*#__PURE__*/React.createElement("span", {
    style: {
  ...
  }, "Mais escolhido")), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("h3", {
    style: {
      fontFamily: "var(--font-display)",
  ...
  }, name), coverage && /*#__PURE__*/React.createElement("p", {
    style: {
  ...
  }, coverage)), price && /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      alignItems: "baseline",
      gap: 4
...
function Logo({
  ...
  if (mono) {
    ...
    }, "Real Vidas"), showTagline && variant !== "mark" && /*#__PURE__*/React.createElement("span", {
      style: {
        fontFamily: "var(--font-body)",
        fontSize: size * 0.21,
        fontWeight: "var(--fw-semibold)",
...
function ProgressBar({
  ...
  }, label && /*#__PURE__*/React.createElement("span", null, label), showValue && /*#__PURE__*/React.createElement("span", null, Math.round(pct), "%")), /*#__PURE__*/React.createElement("div", {
    role: "progressbar",
    "aria-valuenow": pct,
    "aria-valuemin": 0,
    "aria-valuemax": 100,
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "components/actions/ThemeToggle.jsx", error: String((e && e.message) || e) }); }
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "components/brand/EmergencyCTA.jsx", error: String((e && e.message) || e) }); }
...
const STANDARDS = ["Equipe profissional e experiente", "Treinamentos seguindo protocolos internacionais de resgate", "Ambulâncias com tecnologia de última geração", "Normas de segurança para remoção de pacientes", "Certificações de atendimento ao trauma", "Atendimento personalizado, ágil e humanizado"];
function AboutSection() {
  ...
  }, "Foto da equipe")), /*#__PURE__*/React.createElement("div", {
    style: {
      position: "absolute",
      bottom: "var(--space-5)",
      left: "var(--space-5)",
  ...
  }, "Oriunda da consultoria e do treinamento em sa\xFAde"), /*#__PURE__*/React.createElement("p", {
    className: "rv-body",
    style: {
      color: "var(--text-muted)",
      marginBottom: "var(--space-6)"
    }
  }, "A Real Vidas foi criada para prestar servi\xE7os de alt\xEDssima qualidade no atendimento e remo\xE7\xE3o de pacientes de urg\xEAncia e emerg\xEAncia \u2014 com equipe treinada constantemente e t\xE9cnicas atualizadas de resgate."), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "grid",
  ...
  }, STANDARDS.map(t => /*#__PURE__*/React.createElement("div", {
    key: t,
    style: {
      display: "flex",
      gap: "var(--space-2)",
...
function FloatingActions() {
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      ...
      borderRadius: "var(--radius-pill)",
      background: "#25D366",
      animation: "rv-ping 2s var(--ease-out) infinite"
    }
  }), /*#__PURE__*/React.createElement("span", {
    style: {
      position: "relative",
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "ui_kits/website/FloatingActions.jsx", error: String((e && e.message) || e) }); }
...
function Footer({
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
  ...
  }, /*#__PURE__*/React.createElement(EmergencyCTA, null))), /*#__PURE__*/React.createElement("footer", {
    style: {
      background: "var(--secondary)",
  ...
  }, "Servi\xE7os de alt\xEDssima qualidade no atendimento e remo\xE7\xE3o de pacientes de urg\xEAncia e emerg\xEAncia.")), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
    style: {
      fontFamily: "var(--font-display)",
      fontWeight: "var(--fw-bold)",
      color: "#fff",
  ...
  }, [["inicio", "Início"], ["servicos", "Serviços"], ["planos", "Associe-se"], ["contato", "Fale Conosco"]].map(([id, l]) => /*#__PURE__*/React.createElement("button", {
    key: id,
    ...
    name: "phone",
    size: 16
  }), "(12) 99715-1128"), /*#__PURE__*/React.createElement("a", {
    ...
    name: "phone",
    size: 16
  }), "(12) 3522-1128"), /*#__PURE__*/React.createElement("a", {
    ...
    name: "mail",
    size: 16
  }), "faleconosco@realvidas.com.br"), /*#__PURE__*/React.createElement("span", {
    style: {
      display: "inline-flex",
      gap: 8,
      alignItems: "center"
    ...
    name: "map-pin",
    size: 16
  }), "Pindamonhangaba \xB7 SP")))), /*#__PURE__*/React.createElement("div", {
    style: {
  ...
  }, /*#__PURE__*/React.createElement("span", null, "\xA9 2026 Real Vidas \xB7 Remo\xE7\xF5es e Emerg\xEAncias 24h"), /*#__PURE__*/React.createElement("span", null, "Recria\xE7\xE3o de UI para o design system")))));
}
...
function Hero({
  ...
  return /*#__PURE__*/React.createElement("section", {
    style: {
      ...
      color: "#fff",
      overflow: "hidden",
      transition: "background var(--dur-slower) var(--ease-in-out)"
    }
  }, /*#__PURE__*/React.createElement("svg", {
    ...
    href: "https://api.whatsapp.com/send?phone=5512997151128"
  }, s.primary), /*#__PURE__*/React.createElement(Button, {
    variant: "outline",
    size: "lg",
  ...
  }, "Foto da frota / equipe"), /*#__PURE__*/React.createElement("span", {
    style: {
      fontFamily: "var(--font-body)",
      fontSize: "var(--text-xs)",
      opacity: 0.7
...
const PLANS = [{
  ...
  features: ["Remoções simples", "Enfermagem a bordo", "Agendamento por WhatsApp"]
}, {
  tier: "prata",
  name: "Plano Prata",
  coverage: "12 horas de cobertura",
  features: ["Tudo do Bronze", "Remoção emergencial", "Equipe de plantão"]
}, {
  tier: "ouro",
  name: "Plano Ouro",
  coverage: "24 horas de cobertura",
  featured: true,
  features: ["Tudo do Prata", "UTI móvel 24h", "Cobertura de eventos", "Atendimento prioritário"]
}, {
  tier: "custom",
  name: "Remoções particulares",
  coverage: "Emergência e hora marcada",
  features: ["Sob demanda", "Orçamento personalizado", "Pagamento em até 12x"]
}];
function PlansSection() {
  return /*#__PURE__*/React.createElement("section", {
    ...
    className: "rv-eyebrow"
  }, "Associe-se"), /*#__PURE__*/React.createElement("h2", {
    style: {
      fontFamily: "var(--font-display)",
      fontWeight: "var(--fw-extrabold)",
      fontSize: "var(--text-2xl)",
  ...
  }, "Planos que se adaptam \xE0 sua necessidade"), /*#__PURE__*/React.createElement("p", {
    className: "rv-lead",
    style: {
      margin: 0
    }
  }, "Modelos de servi\xE7o e atendimento para diferentes aplica\xE7\xF5es. Conhe\xE7a os detalhes e fale com a gente.")), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "grid",
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "ui_kits/website/PlansSection.jsx", error: String((e && e.message) || e) }); }
...
function QuoteForm() {
  ...
  const submit = e => {
    ...
    const next = {};
    req.forEach(k => {
      if (!form[k].trim()) next[k] = "Campo obrigatório";
    });
    setErrs(next);
  ...
  return /*#__PURE__*/React.createElement("section", {
  ...
  }, "Para remo\xE7\xF5es, preencha os dados abaixo. Para outros servi\xE7os, fale com a gente pelo WhatsApp.")), /*#__PURE__*/React.createElement(Card, {
    variant: "elevated",
  ...
  }, "Recebemos sua solicita\xE7\xE3o. Nossa equipe retornar\xE1 em instantes pelo telefone ou WhatsApp informado."), /*#__PURE__*/React.createElement("form", {
    onSubmit: submit,
    style: {
      display: "flex",
      flexDirection: "column",
  ...
  }, "Origem"), /*#__PURE__*/React.createElement("div", {
    className: "rv-form-grid3",
    style: {
      display: "grid",
    ...
    id: "q-co",
    value: form.cidadeO,
    onChange: set("cidadeO"),
    invalid: !!errs.cidadeO,
  ...
  }, "Destino"), /*#__PURE__*/React.createElement("div", {
    className: "rv-form-grid3",
    style: {
      display: "grid",
      gridTemplateColumns: "2fr 1fr 3fr",
    ...
    id: "q-cd",
    value: form.cidadeD,
    onChange: set("cidadeD"),
    invalid: !!errs.cidadeD,
    placeholder: "S\xE3o Jos\xE9 dos Campos"
  })), /*#__PURE__*/React.createElement(Field, {
    label: "Estado",
    htmlFor: "q-ufd"
  }, /*#__PURE__*/React.createElement(Select, {
    ...
    value: form.obs,
    onChange: set("obs"),
    placeholder: "Condi\xE7\xE3o do paciente, necessidade de UTI, acompanhantes\u2026"
  ...
  }, "Enviar solicita\xE7\xE3o"), /*#__PURE__*/React.createElement(Button, {
    type: "button",
    variant: "whatsapp",
    size: "lg",
    leftIcon: /*#__PURE__*/React.createElement(Icon, {
...
const SERVICES = [{
  ...
  description: "Transferência segura e eficiente em ambulâncias equipadas — emergências, acidentes e remoções hospitalares."
}, {
  icon: "plane",
  title: "Transporte aéreo em UTI",
  description: "Aeronaves com suporte avançado de vida e tripulação de médicos e enfermeiros especializados."
}, {
  icon: "heart-pulse",
  title: "Resgate 24 horas",
  description: "Atendimento de emergência médica disponível 24h por dia, todos os dias da semana."
}, {
  icon: "users",
  title: "Cobertura de eventos",
  description: "Atendimento imediato por profissional especializado em qualquer situação de urgência."
}, {
  icon: "shield-check",
  title: "Postos médicos",
  description: "Montagem e gestão de ambulatórios pontuais ou permanentes para sua empresa."
}, {
  icon: "graduation-cap",
  title: "Educação continuada",
  description: "Capacitação atualizada para técnicos, enfermeiros e médicos."
}, {
  icon: "file-text",
  title: "Planos de emergência",
  description: "Elaboração e execução de PAE com procedimentos estruturados de resposta."
}, {
  icon: "flame",
  title: "Bombeiros profissionais",
  description: "Equipes civis para proteção de pessoas e patrimônios contra riscos de acidentes."
}, {
  icon: "star",
  title: "Certificações",
  description: "PHTLS · ACLS · ATLS · PALS · AMLS · BLS — treinamento e atualização."
}];
function ServicesSection({
  ...
  }, "Servi\xE7os de emerg\xEAncia e remo\xE7\xE3o"), /*#__PURE__*/React.createElement("p", {
    className: "rv-lead",
    style: {
      margin: 0
    }
  }, "Estrutura completa para urg\xEAncia e emerg\xEAncia m\xE9dica, com equipe treinada e equipamentos de \xFAltima gera\xE7\xE3o.")), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "grid",
      gridTemplateColumns: "repeat(auto-fill, minmax(280px, 1fr))",
      gap: "var(--space-5)"
    }
  }, (compact ? SERVICES.slice(0, 6) : SERVICES).map(s => /*#__PURE__*/React.createElement(ServiceCard, {
    key: s.title,
    icon: /*#__PURE__*/React.createElement(Icon, {
      name: s.icon,
      size: 26
...
function SiteHeader({
  ...
  return /*#__PURE__*/React.createElement("header", {
    ...
    name: "map-pin",
    size: 15
  }), /*#__PURE__*/React.createElement("span", null, "Pindamonhangaba \xB7 S\xE3o Paulo")), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      alignItems: "center",
      gap: "var(--space-5)"
  ...
  }, "faleconosco@realvidas.com.br"))))), /*#__PURE__*/React.createElement("div", {
    style: {
      background: "var(--surface)",
      borderBottom: "var(--border-w) solid var(--border)",
      boxShadow: "var(--shadow-xs)"
    ...
    style: {
      ...
      fontWeight: "var(--fw-semibold)",
      fontSize: "var(--text-md)",
      color: n.id === page ? "var(--brand)" : "var(--text-body)",
